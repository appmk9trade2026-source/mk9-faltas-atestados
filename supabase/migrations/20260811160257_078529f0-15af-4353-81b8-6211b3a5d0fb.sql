-- CRM MK9 — CORREÇÃO CIRÚRGICA: DASHBOARD_METRICS (GRANT + CONTRATO)
-- Foco: Restaurar contrato JSON 'ultimos' e permissões após migration AMBEV.

DO $$
BEGIN
    -- 1. Recriar a função com o contrato JSON correto ('ultimos' em vez de 'ultimos_registros')
