-- CRM MK9 — CORREÇÃO CIRÚRGICA: DASHBOARD_METRICS (GRANT + CONTRATO JSON)
-- Restaura o contrato esperado pelo frontend ('ultimos') e as permissões de execução.
...
BEGIN
  ...
  v_result := jsonb_build_object(
    ...
    'heatmap', v_heatmap,
    'ultimos', v_ultimos, -- RESTAURAÇÃO DO CONTRATO: 'ultimos' em vez de 'ultimos_registros'
...
-- Restaurar GRANTs explicitamente usando a assinatura real
...
-- Endurecimento: Bloquear anon e PUBLIC (invoker default)
