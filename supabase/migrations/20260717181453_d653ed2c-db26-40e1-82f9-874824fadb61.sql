...
ALTER TABLE public.ausencias
  ...
  ADD COLUMN IF NOT EXISTS dias_label TEXT;
...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    IF v_colab_ativo IS NOT TRUE THEN RAISE EXCEPTION 'O colaborador está inativo.' USING ERRCODE = 'check_violation'; END IF;
