...
function HomologacaoAmbevTab() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-sm">Matriz de Homologação Funcional — AMBEV (Ponto)</CardTitle>
      </CardHeader>
      <CardContent className="p-6">
        <div className="whitespace-pre-wrap font-mono text-[13px] leading-relaxed bg-muted/40 p-6 rounded-lg border">
