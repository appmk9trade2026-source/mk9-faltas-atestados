...
function NovaAusenciaPage() {
  ...
  const salvarMut = useMutation({
    ...
    onSuccess: () => {
      toast.success("Ausência registrada.", { description: "Status inicial: PENDENTE." });
  ...
  return (
    <AppShell title="Nova Ausência" breadcrumb={["Operações", "Nova Ausência"]}>
      <p className="text-sm text-muted-foreground">
        ...
        <span className="font-medium text-foreground">PENDENTE</span> até o RH efetuar
        o lançamento no sistema do cliente.
      </p>

      <Form {...form}>
        <form
          onSubmit={form.handleSubmit((v) => salvarMut.mutate(v))}
          ...
          <Card className="p-5 space-y-5">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select
                        ...
                        disabled={!projetoId || colabQ.isLoading}
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="sm:col-span-1">
                      ...
                      <Select value={field.value} onValueChange={(v) => field.onChange(v as TipoAusencia)}>
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
            ...
            <div className="flex justify-end gap-2 border-t pt-4">
              ...
              <Button type="submit" disabled={salvarMut.isPending}>
                {salvarMut.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                {salvarMut.isPending ? "Salvando..." : "Registrar ausência"}
              </Button>
            </div>
          </Card>
          ...
          <aside className="space-y-4">
            ...
            <Card className="p-4 text-xs text-muted-foreground">
              ...
              <p className="mt-1 leading-relaxed">
                ...
                <strong>LANCADO</strong> após efetuar o lançamento no sistema do cliente.
              </p>
            </Card>
          </aside>
        </form>
