...
const items: Item[] = [
  ...
  { title: "Auditoria de Estabilidade", url: "/_authenticated/auditoria-estabilidade", icon: ShieldCheck, roles: ["super_admin"] },
];
