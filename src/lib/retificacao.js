...
export function prazoRetificacao(createdAt, agora = new Date()) {
...
export function mapRetificacaoError(message) {
    ...
    if (/RESOURCE_NOT_FOUND/.test(message))
        return "Ausência não encontrada.";
